...
(function (p) {
    ...
    (function (g) {
        var p = g.win.document, m = g.each, z = g.objectEach, A = g.pick, w = g.inArray, x = g.isNumber, B = g.splat, n, u = function (b, a) {
            this.init(b, a)
        };
        g.extend(u.prototype, {
            init: function (b, a) {
                ...
                var b =
                    this, a = this.options, d = a.googleSpreadsheetKey, f = this.columns, e = a.startRow || 0, c = a.endRow || Number.MAX_VALUE, k = a.startColumn || 0, g = a.endColumn || Number.MAX_VALUE, h, q;
                d && jQuery.ajax({
                    dataType: "json",
                ...
                var d = this.rawColumns, f = this.columns, e = b.length, c, k, g, h, n = this.firstRowAsNames, m = -1 !== w(a, this.valueCount.xColumns), p = [], v = this.chartOptions, r, u = (this.options.columnTypes || [])[a], v = m && (v && v.xAxis && "category" === B(v.xAxis)[0].type || "string" === u);
