...
<div class="container-fluid">
	<div class="col-md-4">
		<%--<a href="${pageContext.request.contextPath}/IndexServlet"><img src="img/logo2.png" /></a>--%>
	...
	<div class="col-md-3" style="padding-top:20px">
		<ol class="list-inline">
			...
			<li><a href="${pageContext.request.contextPath}/OrderServlet?method=findByUid&currentPage=1">我的订单</a></li>
		</ol>
	</div>
</div>
			...
			$(function(){
				...
				$.post(
					"${pageContext.request.contextPath}/CategoryServlet",
						{"method":"findAllCategoryList"}
						,
					function(data){
						//[{"cid":"xxx","cname":"xxxx"},{},{}]
						//动态创建<li><a href="#"></a></li>
						for(var i=0;i<data.length;i++){
							content+="<li><a href='${pageContext.request.contextPath}/ProductServlet?method=findByCid&currentPage=1&cid="
									+data[i].cid
									+"'>"
									+data[i].cname
									+"</a></li>";
