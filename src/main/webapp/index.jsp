				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotList }" var="hotPro">
						...
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath}/ProductServlet?method=findById&pid=${hotPro.pid}">
								<img src="${pageContext.request.contextPath }/${hotPro.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findById&pid=${hotPro.pid}" style='color:#666'>${hotPro.pname }</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newList }" var="newPro">
						...
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath}/ProductServlet?method=findById&pid=${newPro.pid}">
								<img src="${pageContext.request.contextPath }/${newPro.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findById&pid=${newPro.pid}" style='color:#666'>${newPro.pname }</a></p>
