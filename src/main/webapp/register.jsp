...
<script type="text/javascript">
   ...
   <%--%>--%>
    ...
    <%--function submitImgSize1Upload(){--%>
        ...
        <%--&lt;%&ndash;action="${pageContext.request.contextPath }/register"&ndash;%&gt;--%>
        <%--var option={--%>
            <%--type:'POST',--%>
...
<div class="container"
    ...
    <div class="row">
        ...
        <div class="col-md-8"
            ...
            <form id="myform" class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet?method=regist"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="checkCode" id="date">
